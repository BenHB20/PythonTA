# -*- coding: utf-8 -*-
"""
Created on Friday 10/10/2025

@author: Yuba

@Student: Ben Howell-Burke
Lab 3, CallingFunctions.py
"""
import random

"""A function to get the min value and index location 
...
"""A function to get the max value and index location
    Parameters :     A list of numbers 
    Return : 
    1.)max value
    2.)index location
...
"""A function to print, min or max value and the corresponding index location 
Parameters : 
...
"""A function to populate a list The list is shuffled after it is populated 
Parameters : 
    1.)starting number
    2.)ending number
    3.)increment
...
"""
# Write your codes after this line

if __name__ == '__main__':

    #create list with values specified from 3 to 50 in intervals of 3
    list = createList(3, 50, 3)

    #store max and min values and locations in two seperate variables for each
    min_value, min_loc = minValue(list)
    max_value, max_loc = maxValue(list)

    #print all the results such as the list and the mins and maxs
    printList(list)
    printResults(0, min_value, min_loc)
    printResults(1, max_value, max_loc)
